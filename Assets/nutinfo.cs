...
public class nutinfo : MonoBehaviour
{
    float timer;
    int preHole;
    ...
    void Start()
    {
        ...
        //}
        xPosition = -3f;
        GameObject[] newnut2 = new GameObject[5];
        ...
        xPosition = -3f;
        GameObject[] newnut3 = new GameObject[5];
        for (int i = 0; i < 5; i++)
        {
            int nut = Random.Range(0, 3);
            if (nut < 2)
    ...
    void Update()
    {
        ...
        if (timer > 1.3 && stageCount < 27)
        {
            ...
            //for (int i = 0; i < 6; i++)
            //{
            //    if (Random.Range(0, 7) < 6) continue;
            //    newleaf[i] = Instantiate(leafTemplate1_1, this.transform);
            //    newleaf[i].transform.position = new Vector3(xPosition+ 0.2f*Random.Range(-4, 5), 5.6f+0.1f*Random.Range(-5,5), 0);
            //    xPosition += 2f;
            //}
            //xPosition = -2f;
            ...
            //    newleaf2[i].transform.position = new Vector3(xPosition + 0.2f * Random.Range(-4, 5), 5.6f + 0.1f * Random.Range(-5, 5), 0);
            //    xPosition += 2f;
            //}
            //xPosition = -2f;
            ...
            //    newleaf3[i].transform.position = new Vector3(xPosition + 0.2f * Random.Range(-4, 5), 5.6f + 0.1f * Random.Range(-9, 10), 0);
            //    xPosition += 2f;
            //}
            //xPosition = -2f;
            ...
            //    newleaf4[i].transform.position = new Vector3(xPosition + 0.2f * Random.Range(-4, 5), 5.6f + 0.1f * Random.Range(-5, 5), 0);
            //    xPosition += 2f;
            //}
